...
if (official.o3.available == TRUE) {
  ...
  officialFileName <- "17nov2017_49c.csv"
  o3_dataDir <- "CMUNov2017Round2" # directory beneath data-raw where the o3 data file is located
...
temp <- mergedDT.wide.rawVal[eggType %in% c("no2co","no2o3", "particulate")]
