...
dataCollectionLocation <- "Glenwood, CO"
dataCollectionLocationAbrev  <- "GC"
dataCollectionDate <- "2015_03_31 - 2015_4_1"
#fileNames
stateDataFileName <- "GACO-VP_MinuteData_150331-150401.csv"
eggDataFileName <- "EggData2015_03_31_140153.csv"
...
tt <- read.csv(paste(getwd(),"/data/csv/",eggDataFileName,sep=""), 
               ...
               sep = ",",
               col.names = c("time","rh","temp","NO2_rs","NO2_est","CO_rs","CO_est","O3_rs","O3_est","dust_est", "dust_rs"),
